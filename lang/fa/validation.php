...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'title' => 'عنوان',
        'type' => 'نوع',
        'due_date' => 'موعد پرداخت',
        'tax' => 'مالیات',
        'payable' => 'مبلغ قابل پرداخت',
        'profit' => 'مقدار سود',
        'items' => 'آیتم ها',
        'items.*.title' => 'عنوان آیتم',
        'items.*.quantity' => 'تعداد آیتم',
        'message' => 'پیام',
        'phone' => 'تلفن',
        'id' => 'شناسه',
        's' => 'عبارت جستجو',
        ...
        'captcha' => 'کد کپچا',
        'sort' => 'چینش',
        'sort_ids' => 'چینش شناسه ها',
        'sort_ids.*' => 'چینش شناسه',
        'created_at_from' => '(از) تاریخ ثبت',
        'created_at_to' => '(تا)تاریخ ثبت',
        'filters' => 'فیلتر',
        'filters.course_ids' => 'شناساه دروس',
        'filters.discussion_ids' => 'شناساه دروس',
        'filters.from' => 'از تاریخ',
        'filters.to' => 'تا تاریخ',
        'filters.status' => 'وضعیت فیلتر ',
    ],
